...
<meta name="data-remix-readonly" content="null">
    ...
    <!--
    <title>Bea Campbell's Tips for Clip Masking On Adobe Illustrator</title>
...
-->         
        <div class="introduction">
          ...
          <div class="information">
            <h1>How to make create a 'Clip Masked Design'</h1>

            <hr>
            <p><b>Assembly time:</b> 5 minutes<br>
              <b>Awesome rating:</b> 100% Easy</p>
            <hr>

            <p>Are you wondering how you can use Adobe to hide parts of images, patterns, or vector art? It's really fun when creating complex designs and cut-outs. But need a step-by-step guide to so it's successful? Follow the steps and voilà! You've got your design!</p>
        ...
        <ol class="step-by-step">
          ...
          <li>
            <div class="Step One: Image">
              <h3>In Adobe Illustrator, import image twice in separate layers.</h3>
              <p>The first layer image acts as the background, and the second is used for clip masking.</p> 
            </div>
          </li>

          <!-- A new step -->
          <li>
            <div class="Step Two: Pen Tracing">
              <h3>With your pen, begin outlining the object in image until it is filled over it.</h3>
              <p>This selects where you want to cut the object that can cover your additional element for hiding or mirroring the image onto that element.</p>
            </div>
          </li>
         <!-- A new step -->
          <li>
            <div class="Step Three: Clip Masking">
              <h3>With your second image layered above the pen tracing, select the following: Object > Clipping Mask > Make OR use the shortcut Ctrl+7 (Windows) or Cmd+7 (Mac).</h3>
              <p>Together, the image will merge with the pen tracing, and now you can use it to go over your additional elements for cover, or have the mirrored image in the element.</p> 
            </div>
          </li>
...
-->
              <a href="https://www.flickr.com/photos/189082773@N07/50083359353/in/photolist-2jiGiRK-Lx7qAm-2m6FFQW-2n2NpHo-2mUE8hL-2owMgNe-2a67Pf8-zbqHyY-2mywM6W-2o3G4j2-2mJXcU5-mbzJd5-2ngdJbk-ztSDsR-2iWLL33-T3HhLd-29P3pU9-r2Ahvd-pC6sk7-2kEH1fG-2mKEBku-27evJj5-6Mzvfo-JZgoST-2mtBRme" title="2006-04-22 cliping mask, on Flickr"><img alt="2020-07-06 Md Naiem Hossain" height="%" width="%" src="//embedr.flickr.com/assets/client-code.js" ></a>
              <p class="caption">Made by Md Naiem Hossain is simple imagery of animals clip masked to different oval shapes.</p>
            </div>
          </li>
          ...
          <li>
            <div class="content">
              ...
              <iframe width="560" height="315" src="https://www.youtube.com/watch?v=IiqlR4RPFfA" frameborder="0" allowfullscreen></iframe>
            </div>
...
-->         
    ...
    <style media="screen" type="text/css">
      ...
      body {
        ...
        width:100%;
        font-weight:normal;
        font-family:Goergia, serif;         /* CHANGE THE FONT HERE */
        color:#8C2C16;         /* CHANGE THE FONT COLOR HERE */
      }  
      ...
      header, footer {
        padding:5%;
        border:0 10%;
        background-color:#8C2C16;          /* CHANGE THE HEADER AND FOOTER COLOR HERE */
        width:100%;
        margin:0px;        
      }
      ...
      a {
        color:#8C2C16;         /* CHANGE THE LINK COLOR HERE */
        font-weight:bold;
      }
      ...
      h1 {
        ...
        width:100%;
        font-weight:bold;
        font-family:Georgia, serif;          /* CHANGE THE HEADER FONT HERE */
      }
      ...
      ul {
        ...
        background-color: #F2E1C2;          /* CHANGE THE THINGS BACKGROUND COLOR HERE */
        border: 1px solid #8C2C16;           /* CHANGE THE THINGS BORDER HERE */
        padding:0;
        margin:2em 0 0;
        position:relative;
        z-index:200;
      ...
      .content {
        background: #D9C5AC;          /* CHANGE THE INSTRUCTION BACKGROUND COLOR HERE */
      }

      .step-by-step li:before {
        background: #F2E1C2;          /* CHANGE THE INSTRUCTION NUMBER BACKGROUND COLOR HERE */
